export function Credits() {
  const bibleSources = [
    { name: "/bible-master", desc: "67 JSON files — Tedim, Hakha, Falam, Paite versions", url: "https://github.com//bible-master" },
  ];

  const dictSources = [
    { name: "/dictionary", desc: "93,931 Zolai→English entries", url: "https://github.com//dictionary" },
    { name: "/zolai-dictionary", desc: "7,861 headwords — trilingual (ZO-EN-MY)", url: "https://github.com//zolai-dictionary" },
    { name: "/zomi-dataset", desc: "130K+ dictionary entries", url: "https://github.com//zomi-dataset" },
  ...
  const corpusSources = [
    { name: "/zomi-dataset", desc: "208MB clean corpus — 3M+ sentences", url: "https://github.com//zomi-dataset" },
  ...
  const contributors = [
    { name: "", role: "Comprehensive Zolai dataset + crawling scripts" },
    { name: "", role: "Bible JSON corpus + trilingual dictionary" },
